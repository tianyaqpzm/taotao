...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fulid" style="padding-right: 15px;">
    <div class="navbar-header"><a class="navbar-brand" target="_blank" href="${g.domain}">dataIntegrity</a></div>
    <div class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a class="dropdown-toggle" data-toggle="dropdown" href="#">你好,  XXX<span class="caret"></span></a>
          <ul class="dropdown-menu">
